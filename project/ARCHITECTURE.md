...
| evaluation | judged | plain-python | Judged: output_shape == freeform |
...
| provisioning | manual-runbook | plain-python | Written steps: always |
...
| serving | self-hosted | plain-python | Self-hosted: data_residency == cannot_leave; hosting == on-prem |
